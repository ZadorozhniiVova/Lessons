      ...
      <div class="header__container">
        <a href="#" class="header__container-logo logo">
          ...
          >
            ...
            <g
              id="tight-bounds"
              transform="matrix(1,0,0,1,0.2399984293703028,-0.09999999999999432)"
            >
              <svg viewBox="0 0 395.52 247.2">
                ...
                <g>
                  <svg viewBox="0 0 395.52 247.2">
                    <g>
                      <path
                        class="logo__img-letters"
                        d="M116.428 244.683c-22.842 0-42.956-4.99-60.342-14.969-17.342-9.979-30.87-24.061-40.583-42.246-2.274-4.276-4.28-8.73-6.018-13.362l42.854 0c5.836 10.497 13.893 18.965 24.172 25.404 12.064 7.584 27.299 11.376 45.705 11.376 5.012 0 10.778-0.399 17.298-1.197 6.564-0.843 12.84-2.218 18.827-4.125v-31.458h36.259v52.947c-8.782 4.879-19.87 9.026-33.265 12.441-13.439 3.46-28.408 5.189-44.907 5.189zM16.501 59.466c10.379-18.14 24.66-32.156 42.845-42.047 18.185-9.935 39.03-14.903 62.537-14.902 12.419 0 24.283 1.308 35.594 3.925 11.31 2.617 21.134 5.788 29.472 9.514l-3.859 33.131c-8.738-3.681-18.162-6.742-28.275-9.181-10.068-2.439-20.868-3.659-32.399-3.659-18.761 0-34.174 3.859-46.238 11.576-10.202 6.503-18.169 14.926-23.9 25.271l-42.335 0c1.887-4.723 4.073-9.266 6.558-13.628zM304.04 244.683c-9.536 0-19.227-0.798-29.073-2.395-9.802-1.641-18.85-3.681-27.144-6.121-8.338-2.439-15.169-4.879-20.491-7.318l4.657-38.587c6.786 3.326 14.415 6.542 22.886 9.647 8.471 3.105 17.431 5.722 26.878 7.85 9.403 2.085 18.939 3.127 28.608 3.127 13.395 0 24.084-2.506 32.067-7.518 7.984-5.056 11.975-12.907 11.975-23.551 0-1.995-0.132-3.898-0.395-5.711l40.4 0c0.074 1.433 0.112 2.893 0.112 4.381 0 8.649-1.53 16.898-4.591 24.748-3.06 7.895-8.072 14.969-15.035 21.223-7.008 6.254-16.3 11.199-27.876 14.836-11.576 3.593-25.902 5.389-42.978 5.389zM228.197 66.851c0-12.507 3.171-23.618 9.514-33.331 6.387-9.713 15.79-17.298 28.208-22.753 12.419-5.5 27.787-8.25 46.105-8.25 14.858 0 28.674 1.641 41.448 4.923 12.818 3.238 23.551 6.742 32.2 10.512l-3.659 37.921c-12.862-6.875-25.037-11.864-36.525-14.969-11.443-3.105-23.219-4.657-35.327-4.657-13.084 0-23.64 2.329-31.668 6.986-8.028 4.657-12.042 12.042-12.042 22.154 0 2.773 0.277 5.341 0.831 7.707l-38.863 0c-0.148-2.018-0.222-4.099-0.222-6.243z"
                        data-fill-palette-color="tertiary"
                      ></path>
                    </g>
                    <g transform="matrix(1,0,0,1,0,80.2636743592628)">
                      <svg
                        viewBox="0 0 395.52 86.6726512814744"
                        height="86.6726512814744"
                        width="395.52"
                      >
                        <g>
                          <svg
        ...
        <nav class="header__container-markets markets">
          <ul class="markets__list">
            ...
            <li class="markets__list-el markets__list-el__nintendo">
              <router-link
                :to="{
              ...
              >
                <svg
                  class="link__img link__img-nintendo"
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 21 16"
                >
                  <path
...
.header {
  ...
  &__container {
    ...
    .logo {
      ...
      &:hover .logo__img-letters {
        fill: white;
      }
      &:hover .logo__img-subtitle {
        fill: #6dc849;
      }
      &:hover {
    ...
    .markets {
      ...
      &__list {
        ...
        &-el {
          ...
          &__nintendo :hover .link__img-nintendo {
            fill: #e52521;
          }
        }
      }
