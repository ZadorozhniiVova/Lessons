        ...
        <v-list nav dense>
          <v-list-item link>
            <router-link class="d-flex align-center" :to="{ name: 'home' }"
              ><v-list-item-icon
                ><v-icon dark>mdi-home</v-icon></v-list-item-icon
              >
          ...
          <v-list-item link>
            <router-link
              ...
              >
              <v-list-item-title>Favorite</v-list-item-title></router-link
            >
          </v-list-item>
          ...
          <v-list-item link>
            <router-link
              :to="{ name: 'BestYear', params: { favorite_data: BESTOFYEAR } }"
              class="d-flex align-center"
              ><v-list-item-icon>
                <svg
                  class="sideMenu__img"
          ...
          <v-list-item link>
            <router-link
              :to="{ name: 'Best2021', params: { favorite_data: BESTOF2021 } }"
              class="d-flex align-center"
              ><v-list-item-icon>
          ...
          <v-list-item link>
            <router-link
              :to="{
                name: 'bestOfAllTime',
                params: { favorite_data: BESTOFALLTIME }
              }"
              class="d-flex align-center"
              ><v-list-item-icon>
          ...
          <v-list-item link>
            <router-link
              ...
              class="d-flex align-center"
              ><v-list-item-icon>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M2 22h9.5v-9.5H2V22zm0-10.5h9.5V2H2v9.5zM12.5 2v9.5H22V2h-9.5zm0 20H22v-9.5h-9.5V22z"/></svg>
              </v-list-item-icon>
              <v-list-item-title> PC</v-list-item-title></router-link
            >
          </v-list-item>
